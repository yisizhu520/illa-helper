...
export class DOMUtils {
     ...
     */
    static getAttribute(element: HTMLElement, name: string, defaultValue = ''): string {
        try {
     ...
     * @param className CSS类名
     */
    static findClosestWithClass(element: HTMLElement, className: string): HTMLElement | null {
