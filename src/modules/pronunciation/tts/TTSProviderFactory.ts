...
export class TTSProviderFactory {
     ...
     * @returns TTS提供者实例
     */
    static createProvider(providerType: TTSProviderType, config?: TTSProviderConfig): ITTSProvider {
        switch (providerType) {
            case 'web-speech':
     ...
     * @param providerType 提供者类型
     */
    static isProviderSupported(providerType: string): providerType is TTSProviderType {
        return this.getSupportedProviders().includes(providerType as TTSProviderType);
    }
