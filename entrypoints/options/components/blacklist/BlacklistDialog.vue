            ...
            <div class="p-6 space-y-4">
                ...
                <div class="space-y-2">
                    <label class="text-sm font-medium text-foreground">
                        网站模式 <span class="text-destructive">*</span>
                    </label>
                    <input v-model="formData.url" @keyup.enter="handleSave" type="text"
                ...
                <div class="bg-muted/50 rounded-md p-4 space-y-2">
                    ...
                    <div class="text-xs text-muted-foreground space-y-1">
                        <div><code>*://example.com/*</code> - 整个域名</div>
                        <div><code>https://example.com/path/*</code> - 特定路径</div>
                        <div><code>*://*.example.com/*</code> - 包含子域名</div>
                        <div><code>file:///*</code> - 本地文件</div>
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <button v-for="preset in presets" :key="preset.pattern" @click="applyPreset(preset.pattern)"
                            ...
                            <div class="text-muted-foreground font-mono">{{ preset.pattern }}</div>
                        </button>
                    </div>
                </div>
            </div>
